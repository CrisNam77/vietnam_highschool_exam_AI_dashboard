...
| `ban` | Ban dự thi cho chương trình 2006: `KHTN` hoặc `KHXH`; thiếu giá trị với chương trình 2018 |
| `diem_anh` | Điểm tiếng Anh dùng cho các phân tích tiếng Anh và các tổ hợp có tiếng Anh; khác với `ngoai_ngu`, là điểm ngoại ngữ nói chung theo `ma_ngoai_ngu` |
